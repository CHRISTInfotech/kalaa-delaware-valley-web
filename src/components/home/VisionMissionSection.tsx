    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Vision Card */}
          <div className="bg-white border-l-4 border-kerala-gold shadow-sm rounded p-6 h-full">
            <h3 className="text-2xl font-bold text-kerala-gold">Vision</h3>
          ...
          {/* Mission Card */}
          <div className="bg-white border-l-4 border-kerala-gold shadow-sm rounded p-6 h-full">
            <h3 className="text-2xl font-bold text-kerala-gold">Mission</h3>
            <ul className="mt-4 pl-4 list-disc text-gray-700 space-y-2">
              <li>
